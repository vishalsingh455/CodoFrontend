...
const CODE_SNIPPET = `function solve(n) {
  if (n <= 1) return n;
  return solve(n - 1) + solve(n - 2);
}

> Runtime: 12ms  ✓ Accepted`;
    ...
    return (
        <div className="w-full rounded-xl bg-black/40 border border-white/10 shadow-2xl overflow-hidden">
            <div className="flex items-center gap-1.5 px-4 py-2.5 bg-white/5 border-b border-white/10">
                ...
                <span className="ml-2 text-[11px] text-gray-500 font-mono-ui">solution.js</span>
            </div>
            <pre className="font-mono-ui text-[13px] leading-relaxed text-cyan-300/90 p-5 min-h-[140px] whitespace-pre-wrap">
                {typed}
                <span className="inline-block w-1.5 h-4 bg-violet-400 anim-blink align-middle ml-0.5" />
            </pre>
        </div>
    );
};
    ...
    return (
        <div className="min-h-screen flex bg-[#0A0D14]">
            <style>{`
                ...
                .anim-float-a { animation: floatSlow 9s ease-in-out infinite; }
                .anim-float-b { animation: floatSlow2 11s ease-in-out infinite; }
                ...
                .gradient-border-wrap::before { content: ""; position: absolute; inset: -60%; background: conic-gradient(from 0deg, #7c5cff, #22d3ee, #7c5cff); animation: spin 5s linear infinite; }
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center p-12 border-r border-white/5">
                ...
                <div className="absolute -top-24 -left-10 w-80 h-80 bg-violet-600/20 rounded-full blur-3xl anim-float-a" />
                <div className="absolute bottom-0 right-0 w-80 h-80 bg-cyan-500/15 rounded-full blur-3xl anim-float-b" />

                <div className="relative z-10 w-full max-w-md anim-fade-up">
                    <p className="font-mono-ui text-xs text-cyan-400 tracking-widest mb-3">// Codo</p>
                    <h1 className="font-mono-ui text-4xl font-bold text-white leading-tight mb-4">
                        Compete. Solve.
                        <br />
                        <span className="bg-gradient-to-r from-violet-400 to-cyan-300 bg-clip-text text-transparent">Rank up.</span>
                    </h1>
                    <p className="text-gray-400 text-sm mb-8">
                        Sharpen your skills against thousands of coders in real-time challenges.
                    </p>
            ...
            <div className="flex-1 relative flex items-center justify-center p-4 overflow-hidden">
                ...
                <div className="absolute -bottom-24 -right-16 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl anim-float-b" />
                    ...
                    >
                        <div className="flex flex-col items-center mb-7">
                            <div className="relative mb-4">
                                <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-violet-500 to-cyan-400 blur-md opacity-40" />
                                <div className="relative w-12 h-12 rounded-xl bg-gradient-to-br from-violet-600 to-cyan-500 flex items-center justify-center font-mono-ui text-white font-bold text-lg shadow-lg">
                                    {'</>'}
                                </div>
                            </div>
                            <p className="font-mono-ui text-xs text-cyan-400/80 tracking-wider"></p>
                            <h2 className="font-mono-ui text-2xl text-white font-bold mt-1 flex items-center gap-1">
                                Welcome back
                                <span className="inline-block w-2 h-5 bg-violet-400 anim-blink translate-y-0.5" />
                            </h2>
                        </div>
                        ...
                        <div className="space-y-5">
                            <div className="relative anim-fade-in" style={{ animationDelay: '80ms' }}>
                                ...
                                <input
                                    id="login-email"
                                    className="peer w-full pl-10 pr-4 pt-4 pb-1.5 rounded-lg bg-gray-800/70 border border-white/5 text-white outline-none placeholder-transparent transition-all focus:border-violet-500/60 focus:ring-2 focus:ring-violet-500/20"
                                    placeholder=" "
                                    value={email}
                                    onChange={(e) => setEmail(e.target.value)}
                                />
                                <label htmlFor="login-email" className="absolute left-10 top-2.5 text-[10px] text-gray-500 transition-all peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-sm peer-placeholder-shown:text-gray-500 peer-focus:top-2.5 peer-focus:text-[10px] peer-focus:text-cyan-400">
                                    Email
                                </label>
                            </div>

                            <div className="relative anim-fade-in" style={{ animationDelay: '160ms' }}>
                                <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 z-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
                                ...
                                <input
                                    ...
                                    className="peer w-full pl-10 pr-10 pt-4 pb-1.5 rounded-lg bg-gray-800/70 border border-white/5 text-white outline-none placeholder-transparent transition-all focus:border-violet-500/60 focus:ring-2 focus:ring-violet-500/20"
                                    placeholder=" "
                                    value={password}
                                    onChange={(e) => setPassword(e.target.value)}
                                />
                                <label htmlFor="login-password" className="absolute left-10 top-2.5 text-[10px] text-gray-500 transition-all peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-sm peer-placeholder-shown:text-gray-500 peer-focus:top-2.5 peer-focus:text-[10px] peer-focus:text-cyan-400">
                                    Password
                                </label>
                                <button
                                    type="button"
                            ...
                            <button className="btn-shine w-full py-2.5 rounded-lg text-white font-semibold bg-gradient-to-r from-violet-600 to-cyan-500 hover:shadow-lg hover:shadow-violet-600/30 active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2 group anim-fade-in" style={{ animationDelay: '240ms' }}>
                                Login
                        ...
                        <div className="mt-5 flex flex-col items-center gap-2 text-sm">
                            <p className="text-violet-400 hover:text-violet-300 cursor-pointer transition-colors" onClick={() => setShowForgotPassword(true)}>
                                Forgot Password?
                            </p>
                            <p className="text-gray-500">
                                Don't have an account?{" "}
                                <span className="text-cyan-400 hover:text-cyan-300 cursor-pointer transition-colors" onClick={() => navigate('/register')}>
                                    Register
                                </span>
                            </p>
                        </div>
            ...
            {/* Forgot Password Modal */}
            {showForgotPassword && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 anim-fade-in">
                    <div className="gradient-border-wrap w-96 anim-fade-up" style={{ animationDuration: '.35s' }}>
                        <div className="card-inner bg-[#12161f]/95 p-8 relative">
                            <button
                                onClick={closeForgotPassword}
                            ...
                            <div className="flex items-center justify-center gap-2 mb-6">
                                <span className={`w-2 h-2 rounded-full transition-colors ${forgotPasswordStep === 'email' ? 'bg-violet-500' : 'bg-gray-700'}`} />
                                <span className={`w-2 h-2 rounded-full transition-colors ${forgotPasswordStep === 'otp' ? 'bg-violet-500' : 'bg-gray-700'}`} />
                            </div>

                            <h3 className="font-mono-ui text-xl text-white font-bold mb-6 text-center flex items-center justify-center gap-2">
                            ...
                            {forgotPasswordStep === 'email' ? (
                                <form onSubmit={handleForgotPassword} className="space-y-4">
                                    <div className="relative">
                                        ...
                                        <input
                                            className="w-full pl-10 pr-4 py-2.5 rounded-lg bg-gray-800/70 border border-white/5 text-white outline-none placeholder-gray-500 transition-all focus:border-violet-500/60 focus:ring-2 focus:ring-violet-500/20"
                                            placeholder="Enter your email"
                                            value={forgotEmail}
                                            onChange={(e) => setForgotEmail(e.target.value)}
                                            required
                                    ...
                                    <button className="btn-shine w-full py-2.5 rounded-lg text-white font-semibold bg-gradient-to-r from-violet-600 to-cyan-500 hover:shadow-lg hover:shadow-violet-600/30 active:scale-[0.98] transition-all duration-200">
                                        Send OTP
                                    </button>
                                </form>
                            ) : (
                                <form onSubmit={handleResetPassword} className="space-y-4">
                                    <input
                                        className="w-full px-4 py-2.5 rounded-lg bg-gray-800/70 border border-white/5 text-white outline-none placeholder-gray-500 tracking-[0.3em] text-center transition-all focus:border-violet-500/60 focus:ring-2 focus:ring-violet-500/20"
                                        placeholder="000000"
                                        value={otp}
                                        onChange={(e) => setOtp(e.target.value)}
                                        required
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full px-4 pr-10 py-2.5 rounded-lg bg-gray-800/70 border border-white/5 text-white outline-none placeholder-gray-500 transition-all focus:border-violet-500/60 focus:ring-2 focus:ring-violet-500/20"
                                            placeholder="New Password"
                                            value={newPassword}
                                            onChange={(e) => setNewPassword(e.target.value)}
                                            required
